...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // Calcular limite de data (45 dias antes do início do intervalo selecionado) para resgatar dados recentes e pendências
    const limitDate = new Date(startDate);
    limitDate.setDate(limitDate.getDate() - 45);
    limitDate.setHours(0, 0, 0, 0);
    const orderLimitTimestamp = Timestamp.fromDate(limitDate);

    // Operations (filtrado para os últimos 45 dias para evitar carregar registros históricos gigantesco)
    const qOps = query(
      collection(db, 'operations'), 
      where('created_at', '>=', orderLimitTimestamp),
    ...
    // Purchase Orders (filtrado para os últimos 45 dias para evitar carregar registros históricos gigantesco)
    const qPOs = query(
    ...
    // Receipts (filtrado para os últimos 45 dias para evitar carregar registros históricos gigantesco)
